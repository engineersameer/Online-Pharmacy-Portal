        ...
        <nav>
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/admin/home" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-primary-600">PharmaCare Admin</span>
            </Link>

            {/* Nav links */}
            <div className="hidden md:flex items-center space-x-8">
              <Link to="/admin/home" className={linkStyle('/admin/home')}>Home</Link>
              <Link to="/admin/customers" className={linkStyle('/admin/customers')}>Customers</Link>
